...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _project_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project_controller */ \"./src/project_controller.js\");\n/* harmony import */ var _view_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view_controller */ \"./src/view_controller.js\");\n\n\n\n(() => {\n  _project_controller__WEBPACK_IMPORTED_MODULE_0__[\"default\"].project('📨 Inbox');\n\n  // Add all projects to the sidebar\n  _project_controller__WEBPACK_IMPORTED_MODULE_0__[\"default\"].projectList.forEach((project) => {\n    _view_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addProjectToSidebar(project);\n  })\n})();\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");

/***/ }),

/***/ "./src/project_controller.js":
/*!***********************************!*\
  !*** ./src/project_controller.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {\n  const projectList = [];\n\n  // Creates a new project and adds it to the project list\n  const project = (name) => {\n    const newProject = { name }\n\n    projectList.push(newProject);\n\n    return newProject;\n  }\n\n  // Makes sure a project name is unique and not blank\n  const validateProjectName = (name) => {\n    if(!name) return { result: false, message: 'Name cannot be blank.' };\n    if(projectList.find(p => p.name == name)) return { result: false, message: 'Name must be unique.' };\n\n    return { result: true, message: 'Project successfully created.' };\n  }\n\n  return { projectList, project, validateProjectName };\n})());\n\n\n//# sourceURL=webpack://todo-list/./src/project_controller.js?");
